...
def do_action(event, _):
    ...
    This ensures that when code pipeline for tenant templates is kicked off,
    it always create a default stack for pooled tenants.
    ...
    tenantstackmap_table_name = event["ResourceProperties"][
